...
const sendMail = async (to, order) => {
  try {
    ...
    const shippingFeeHtml = order.shippingFee > 0 ? `+${order.shippingFee.toLocaleString('vi-VN')}₫` : '0₫';
