...
import {
  ...
  useSafeState,
  useToken
} from "./chunk-SBETCHDP.js";
import {
  require_react_dom
} from "./chunk-MHOJAHLE.js";
import {
...
} from "./chunk-NAECGPKJ.js";
import {
  getShadowRoot
} from "./chunk-VHUHQBN7.js";
import {
  _extends,
  _objectSpread2,
  ...
  warning,
  warning_default
} from "./chunk-3WLGXMN2.js";
import {
  require_react
} from "./chunk-SZZHCZ7W.js";
import {
  __toESM
...
var ErrorList = (_ref) => {
  ...
  return wrapCSSVar(React9.createElement(es_default, {
...
function Mask(props) {
  ...
  return React22.createElement(es_default, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
...
var PopupContent = React23.memo(function(_ref) {
...
// node_modules/@rc-component/trigger/es/Popup/index.js
var Popup2 = React24.forwardRef(function(props, ref) {
  ...
  var _React$useState = React24.useState(!getPopupContainer || !getPopupContainerNeedParams), _React$useState2 = _slicedToArray(_React$useState, 2), show = _React$useState2[0], setShow = _React$useState2[1];
  useLayoutEffect_default(function() {
  ...
  return React24.createElement(Portal2, {
    open: forceRender || isNodeVisible,
    getContainer: getPopupContainer && function() {
      return getPopupContainer(target);
    },
    autoDestroy
  }, React24.createElement(Mask, {
    prefixCls,
    open,
    zIndex,
    mask,
    motion: maskMotion
  }), React24.createElement(es_default3, {
    onResize: onAlign,
    disabled: !open
  }, function(resizeObserverRef) {
    return React24.createElement(es_default, _extends({
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
      removeOnLeave: false,
      ...
      return React24.createElement("div", {
        ...
        onPointerEnter,
        onClick
      }, arrow && React24.createElement(Arrow, {
        prefixCls,
        arrow,
        arrowPos,
        align
      }), React24.createElement(PopupContent_default, {
        cache: !open && !fresh
      }, childNode));
    });
  }));
...
var TriggerWrapper = React25.forwardRef(function(props, ref) {
  var children = props.children, getTriggerDOMNode = props.getTriggerDOMNode;
  var canUseRef = supportRef(children);
  var setRef = React25.useCallback(function(node) {
    fillRef(ref, getTriggerDOMNode ? getTriggerDOMNode(node) : node);
  }, [getTriggerDOMNode]);
  var mergedRef = useComposeRef(setRef, children.ref);
  return canUseRef ? React25.cloneElement(children, {
    ref: mergedRef
  }) : children;
});
if (true) {
...
function useAlign(open, popupEle, target, placement, builtinPlacements, popupAlign, onPopupAlign) {
  ...
  var alignCountRef = React28.useRef(0);
  var scrollerList = React28.useMemo(function() {
    if (!popupEle) {
      return [];
    }
    return collectScroller(popupEle);
  }, [popupEle]);
  var prevFlipRef = React28.useRef({});
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  var openRef = React29.useRef(open);
...
function generateTrigger() {
  ...
  var Trigger = React30.forwardRef(function(props, ref) {
    ...
    var externalPopupRef = React30.useRef(null);
    ...
    var externalForwardRef = React30.useRef(null);
    ...
    var lastTriggerRef = React30.useRef([]);
    ...
    return React30.createElement(React30.Fragment, null, React30.createElement(es_default3, {
      disabled: !mergedOpen,
      ref: setTargetRef,
...
var Tooltip = function Tooltip2(props, ref) {
  ...
  var getPopupElement = function getPopupElement2() {
    return React31.createElement(Popup, {
      key: "content",
      prefixCls,
      id,
      overlayInnerStyle
  ...
  return React31.createElement(es_default4, _extends({
...
var SpaceCompactItemContext = React34.createContext(null);
var useCompactItemContext = (prefixCls, direction) => {
  const compactItemContext = React34.useContext(SpaceCompactItemContext);
  const compactItemClassnames = React34.useMemo(() => {
...
var NoCompactStyle = (_ref) => {
  ...
  return React34.createElement(SpaceCompactItemContext.Provider, {
    value: null
  }, children);
};
var CompactItem = (_a) => {
...
var Compact = (props) => {
  ...
  const nodes = React34.useMemo(() => childNodes.map((child, i) => {
    const key = child && child.key || `${prefixCls}-item-${i}`;
    return React34.createElement(CompactItem, {
      key,
...
var PurePanel = (props) => {
  ...
  }), React35.createElement(Popup, Object.assign({}, props, {
    className: hashId,
    prefixCls,
...
var InternalTooltip = React36.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const child = React36.isValidElement(children) && !isFragment(children) ? children : React36.createElement("span", null, children);
  ...
  const content = React36.createElement(es_default5, Object.assign({}, otherProps, {
    zIndex,
  ...
  return wrapCSSVar(React36.createElement(zindexContext_default.Provider, {
    value: contextZIndex
  }, content));
});
...
function toTooltipProps(tooltip) {
  ...
  if (typeof tooltip === "object" && !React37.isValidElement(tooltip)) {
    return tooltip;
  }
  return {
    title: tooltip
...
var FormItemLabel = (_ref) => {
  ...
  if (tooltipProps) {
    const {
      icon = React37.createElement(QuestionCircleOutlined_default, null)
    } = tooltipProps, restTooltipProps = __rest5(tooltipProps, ["icon"]);
    const tooltipNode = React37.createElement(tooltip_default, Object.assign({}, restTooltipProps), React37.cloneElement(icon, {
    ...
    labelChildren = React37.createElement(React37.Fragment, null, labelChildren, tooltipNode);
  }
  ...
  if (isRenderMark) {
    ...
    labelChildren = React37.createElement(React37.Fragment, null, labelChildren, React37.createElement("span", {
  ...
  return React37.createElement(col_default, Object.assign({}, mergedLabelCol, {
    className: labelColClassName
  }), React37.createElement("label", {
    htmlFor,
...
function StatusProvider(_ref) {
  ...
  } = React38.useContext(FormItemInputContext);
  const formItemStatusContext = React38.useMemo(() => {
    var _a;
    let feedbackIcon;
    if (hasFeedback) {
      ...
      feedbackIcon = customIconNode !== false && IconNode ? React38.createElement("span", {
        className: (0, import_classnames15.default)(`${itemPrefixCls}-feedback-icon`, `${itemPrefixCls}-feedback-icon-${mergedValidateStatus}`)
      }, customIconNode || React38.createElement(IconNode, null)) : null;
    }
    const context = {
      status: mergedValidateStatus || "",
      errors,
...
function ItemHolder(props) {
  const {
    ...
    isRequired,
    onSubItemMetaChange
  } = props, restProps = __rest6(props, ["prefixCls", "className", "rootClassName", "style", "help", "errors", "warnings", "validateStatus", "meta", "hasFeedback", "hidden", "children", "fieldId", "required", "isRequired", "onSubItemMetaChange"]);
  const itemPrefixCls = `${prefixCls}-item`;
  const {
    requiredMark
  ...
  const [marginBottom, setMarginBottom] = React39.useState(null);
  useLayoutEffect_default(() => {
  ...
  return React39.createElement("div", {
    ...
    style,
    ref: itemRef
  }, React39.createElement(row_default, Object.assign({
    ...
    "wrapperCol",
    "validateDebounce"
  ])), React39.createElement(FormItemLabel_default, Object.assign({
    htmlFor: fieldId
  }, props, {
    requiredMark,
    required: required !== null && required !== void 0 ? required : isRequired,
    prefixCls
  })), React39.createElement(FormItemInput_default, Object.assign({}, props, meta, {
    ...
    marginBottom,
    onErrorVisibleChanged
  }), React39.createElement(NoStyleItemContext.Provider, {
    value: onSubItemMetaChange
  }, React39.createElement(StatusProvider, {
    prefixCls,
    meta,
    errors: meta.errors,
  ...
  }, children)))), !!marginBottom && React39.createElement("div", {
...
var MemoInput = React40.memo((_ref) => {
  let {
    children
  } = _ref;
  return children;
...
function InternalFormItem(props) {
  ...
  const {
    name: formName
  } = React40.useContext(FormContext);
  const mergedChildren = useChildren(children);
  const isRenderProps = typeof mergedChildren === "function";
  const notifyParentMetaChange = React40.useContext(NoStyleItemContext);
  const {
    validateTrigger: contextValidateTrigger
  } = React40.useContext(FieldContext_default);
  ...
  const listContext = React40.useContext(ListContext_default);
  const fieldKeyPathRef = React40.useRef();
  ...
  const [mergedErrors, mergedWarnings] = React40.useMemo(() => {
  ...
  function renderLayout(baseChildren, fieldId, isRequired) {
    if (noStyle && !hidden) {
      return React40.createElement(StatusProvider, {
        prefixCls,
    ...
    return React40.createElement(ItemHolder, Object.assign({
      key: "row"
    }, props, {
  ...
  return wrapCSSVar(React40.createElement(Field_default, Object.assign({}, props, {
    ...
    if (Array.isArray(mergedChildren) && hasName) {
    ...
    } else if (React40.isValidElement(mergedChildren)) {
      ...
      childNode = React40.createElement(MemoInput, {
...
//# sourceMappingURL=chunk-OXH3MVPW.js.map
